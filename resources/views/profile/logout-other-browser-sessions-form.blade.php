<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-button class="bg-green-600 hover:bg-orange-500 text-white transition-colors duration-200" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="footer">
                <x-secondary-button class="bg-gray-600 hover:bg-gray-700 text-white transition-colors duration-200" wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                    {{ __('Cancelar') }}
                </x-secondary-button>

                <x-button class="ms-3 bg-green-600 hover:bg-orange-500 text-white transition-colors duration-200"
